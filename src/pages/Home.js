...
const BENTO_IMAGES = [
    { src: './assets/images/bento-1.jpg', alt: 'Présentation produit 1', className: 'one' },
    { src: './assets/images/bento-2.jpg', alt: 'Présentation produit 2', className: 'two' },
    { src: './assets/images/bento-3.jpg', alt: 'Présentation produit 3', className: 'three' },
